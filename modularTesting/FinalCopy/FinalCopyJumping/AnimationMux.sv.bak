...
(
				input [20:0] address1, address2, address3, address4, address5, address6,
				input playerOn1, playerOn2, playerOn3, playerOn4, playerOn5, playerOn6,
				input [9:0] playerHeight1, playerHeight2, playerHeight3, playerHeight4, playerHeight5, playerHeight6,
				input [9:0] playerWidth1, playerWidth2, playerWidth3, playerWidth4, playerWidth5, playerWidth6, 
				input [4:0] keycode,
